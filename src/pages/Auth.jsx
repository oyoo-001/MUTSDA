...
export default function AuthPage() {
  ...
  const handleCapacitorGoogleLogin = async () => {
    try {
      ...
      await Browser.open({ url: 'https://mutsda.onrender.com/api/auth/google/init' });
    } catch (err) {
      toast({ variant: "destructive", title: "Error", description: "Failed to open Google login." });
    }
  };
            ...
            <Card className="border-t-0 rounded-t-none">
              ...
              <CardContent>
                ...
                <div className="flex justify-center">
                  {isCapacitor ? (
                    <Button onClick={handleCapacitorGoogleLogin} className="w-full bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 flex items-center justify-center gap-2">
